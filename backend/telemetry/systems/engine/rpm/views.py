...
from .comparison import compute_rpm_comparison
...
@require_GET
def get_rpm_comparison(request: HttpRequest) -> JsonResponse:
    ...
    try:
        ...
        payload = compute_rpm_comparison(
            lap=lap,
        ...
        return JsonResponse(
            {
                "error": "Unable to compute RPM comparison.",
                "details": str(exc),
            },
            status=500,
        )
